    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-accent/10 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-2">AuraOS</h1>
          <p className="text-lg text-muted-foreground">AI-Powered Social Media Automation</p>
        </div>
        ...
        <Card className="shadow-2xl border-0 bg-card/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-4">
            ...
            <p className="text-muted-foreground">
              Sign in to access your AI-powered social media dashboard
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-medium text-foreground text-center">What you'll get access to:</h3>
        ...
        <div className="text-center mt-8">
          <p className="text-xs text-muted-foreground">
            Powered by Firebase • Secure Authentication • Cloud Storage
          </p>
        </div>
      </div>
    </div>
